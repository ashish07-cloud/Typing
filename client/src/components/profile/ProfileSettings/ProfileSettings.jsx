        ...
        <div className="flex-1 p-8 md:p-12 animate-in fade-in slide-in-from-right-4 duration-500">
          ...
          {activeSection === "danger" && (
            <div className="max-w-md space-y-6">
              <h2 className="text-2xl font-bold text-red-500 tracking-tighter">
                danger_zone
              </h2>
              <div className="p-6 rounded-2xl border border-red-500/20 bg-red-500/5">
                <p className="text-sm text-[var(--text-color)] mb-4 font-medium">
                  Deleting your account will wipe all your WPM history and
                  leaderboard entries. This cannot be undone.
                </p>
                <button
                  onClick={() => setShowDeleteModal(true)}
                  className="w-full py-3 rounded-xl bg-red-500 text-white font-bold text-xs uppercase tracking-widest hover:bg-red-600 transition-colors"
                >
                  delete_my_account
                </button>
              </div>
